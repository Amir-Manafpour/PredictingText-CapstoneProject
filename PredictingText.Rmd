...
#TODO: function below is incomplete
...
getOrderedFreqDt <- function(dtminput){
...
getProbMatrix <- function(inputDocs, maxngram = 3, bareMatOnly = F) {
  #TODO: reduce freq sizes to limit to 90% or so of words
...
```{r model-testing}
pmat_sp <- getProbMatrix(docsOrig, bareMatOnly = T)
